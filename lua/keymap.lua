...
map("",  "<C-h>", ":NvimTreeFocus<CR>", opt)     -- nvimtree focus
map("",  "<C-l>", ":buffer<CR>", opt)     -- focus code area
...
-- move Line Code
map("n",  "<A-j>", ":move +1<CR>", opt)     -- Geser Ke bawah
map("n",  "<A-k>", ":move -2<CR>", opt)     -- Geser Ke atas
